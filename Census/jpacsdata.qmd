...
itables.show(pd.DataFrame(jpmap.loc[:,["ST","state","population","epopulation","eng","eeng","jpn","ejpn","bilingual","ebilingual",
                            "jpnloweng","ejpnloweng","pctjpn","pctbilingual","bilingualratio"]]), 
                            maxBytes=200000, style="width:100%", 
                            buttons=["pageLength", {"extend": "colvisGroup","text": "Hide Errors","hide": [1,3,5,7,9,11]},
                                                    {"extend": "colvisGroup","text": "Show all","show": "*"}],
                            columnDefs=[{"className":"dt-left", "targets":[0]}, 
                                        {"targets":[1,3,5,7,9,11], "visible":False}],
                            columnControl=["order"],
...
itables.show(pd.DataFrame(jpmetro.loc[:,["metro-area","population","epopulation","eng","eeng","jpn","ejpn","bilingual","ebilingual","pctjpn","pctbilingual","bilingualratio"]]), 
                            maxBytes=200000, style="width:100%", 
                            buttons=["pageLength", {"extend": "colvisGroup","text": "Hide Errors","hide": [2,4,6,8]},
                                                    {"extend": "colvisGroup","text": "Show all","show": "*"}],
                            columnDefs=[{"className":"dt-left", "targets":[0]}, 
