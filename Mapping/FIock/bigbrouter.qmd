---
title: Editing PBF files for ALPR avoidance
format: 
  html:
    code-fold: true
---

A (step by step) guide to running the [Big B-router](https://github.com/pickpj/Big-B-Router) ipynb. For offline ALPR avoidance in the [Osmand](https://osmand.net/) mobile app.  
...
::: {.callout-note collapse="true"}  
## Why:  
1. ~~The map file expands a lot when loaded into memory.~~ No longer the case.  
2. Converting from pbf to obf is slower for larger files.  
:::  
...
This uses a bit of ram. Probably around 3~4GB  
